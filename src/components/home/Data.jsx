...
const Data = () => {
    return(
        <div className="home_data">
            <h1 className="home_title">Joshua DA
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">Creative, smart, hardworking, skilled. If these attributes are what you're looking for, then I am perfect for you.</p>
            <a href="#contact" className="button button--flex">Get into Contact</a>
        </div>
    );
};
