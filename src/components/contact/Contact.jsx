...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_iad7fw6', 'template_vohajtp', form.current, 'NCCntMGXsonwCKaMv')
    ...
    return(
        <section className="contact section" id="contact">
            ...
            <div className="contact_container container grid">
                ...
                <div className="contact_content">
                    <h3 className="contact_title">Quick contact</h3>
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact_form">
                        ...
                        <div className="contact_form-div contact_form-area">
                            ...
                            <textarea name="content" cols="30" rows="10" className="contact_form-input" placeholder="Write your message*"></textarea>
